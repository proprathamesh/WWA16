<?php
    ...
    require "./Partials/loginCheck.php";
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body style="min-height: 100vh;">
        <div class="h-100">
            <div  style="width: 100%;height: 75px;">
                <div class="icon">
                    <h2 class="logo" style="color: #ff7200;"><strong>JobSeeker</strong></h2>
                </div>
            </div>

            <div class="content" style="min-height: 90vh;">
                <div class="intro">
                    <h1>If Opportunity doesn't  <br><span style="color: #ff7200;"> <strong>knock build </strong> </span> <br> a door</h1>
                </div>
                ...
                <div id="loginBox">
                    <div class="form">
                        ...
                        <div class="link">Don't have an account<br>
                            <a class="" onclick="change()" style="color: #ff7200;" href="#">Sign up </a> here
                        </div>
